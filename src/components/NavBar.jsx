...
const NavBar = () => {
  ...
  return (
    <nav className="relative top-0 z-30 flex items-center justify-between w-full h-20 px-4 pt-1 text-white bg-gray-900">
      <div>
        <h1 className="ml-2 text-5xl font-signature">Paul</h1>
      </div>

      <ul className="hidden md:flex">
        {links.map(({ id, link }) => (
          <li key={id} className="px-4 font-medium text-gray-300 capitalize duration-200 cursor-pointer hover:scale-110 hover:text-gray-50">
